...
// Gold shimmer effect on viewport enter
ScrollTrigger.batch(".gold-shimmer-trigger", {
  onEnter: (batch) => {
    batch.forEach((el) => {
      el.classList.add("gold-shimmer");
      setTimeout(() => el.classList.remove("gold-shimmer"), 1500);
    });
  },
  start: "top 80%",
  once: true,
